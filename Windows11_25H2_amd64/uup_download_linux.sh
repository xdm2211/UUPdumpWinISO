...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b2afa3be-e5ab-4327-a5f9-f6583c29eb61&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
