...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=038c7416-2aa2-4174-85a2-158aa9b11289&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
