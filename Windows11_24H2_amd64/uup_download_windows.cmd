@echo off
:: Generated on 2026-04-15 11:30:04 GMT
...
:START_PROCESS
title 26100.8246_amd64_zh-cn_professional_a6042b7d download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=a6042b7d-8a13-4890-8f71-ecbb73ccc08b&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
