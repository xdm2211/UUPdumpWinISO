@echo off
:: Generated on 2026-04-15 11:24:46 GMT
...
:START_PROCESS
title 26300.8170_amd64_zh-cn_professional_dd4ba689 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=dd4ba689-e767-4b3c-a6b1-76a44f4d65cb&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
