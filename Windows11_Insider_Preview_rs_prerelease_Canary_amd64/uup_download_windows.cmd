@echo off
:: Generated on 2026-04-19 02:50:20 GMT
...
:START_PROCESS
title 29570.1000_amd64_zh-cn_professional_56c13762 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=56c13762-cf6d-4597-ba11-d6ee9c20dbde&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
