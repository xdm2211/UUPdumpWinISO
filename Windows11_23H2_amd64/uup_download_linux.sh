...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=51ac5244-1907-4a06-ae4f-132c783a5eca&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
