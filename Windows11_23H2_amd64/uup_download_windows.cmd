@echo off
:: Generated on 2026-04-15 11:31:09 GMT
...
:START_PROCESS
title 22631.6936_amd64_zh-cn_professional_59fd22e9 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=59fd22e9-ef3d-4734-8a78-4354718ad854&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
