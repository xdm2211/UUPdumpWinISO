@echo off
:: Generated on 2026-01-26 06:12:29 GMT
...
:START_PROCESS
title 22631.6495_amd64_zh-cn_professional_51ac5244 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=51ac5244-1907-4a06-ae4f-132c783a5eca&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
